...
public class AwsSqsClientSteps
{
    ...
    public void DadoEuTenhoUmaMensagemParaEnviar()
    {
        ...
        _sqsClientMock.Setup(client => 
                client.SendMessageAsync(It.IsAny<SendMessageRequest>(), default))
    ...
    {
        _sqsClientMock.Verify(m => 
            m.SendMessageAsync(It.IsAny<SendMessageRequest>(),default), Times.Once);
    }
    ...
    public void DadoQueEuTenhoUmaFilaComMensagensComOURL(string queueUrl)
    {
        ...
        _sqsClientMock.Setup(m => 
                m.ReceiveMessageAsync(It.IsAny<ReceiveMessageRequest>(), default))
    ...
    {
        _sqsClientMock.Verify(m => 
            m.ReceiveMessageAsync(It.IsAny<ReceiveMessageRequest>(), default), Times.Once);
